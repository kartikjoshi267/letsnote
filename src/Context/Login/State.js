...
function LoginContextProvider(props) {
    ...
    return (
        <React.Fragment>
            <loginContext.Provider value={{ credentials, setCredentials, newCredentials, setNewCredentials, loginRequest, errors, setError, isLoggedIn, setIsLoggedIn, signUpRequest, name, authenticate, remainLoggedIn, fetchNotes, notes, newNote, setNewNote, addNote, updatedNote, setUpdatedNote, editNote, deleteNote, signOut }} >
                {props.children}
